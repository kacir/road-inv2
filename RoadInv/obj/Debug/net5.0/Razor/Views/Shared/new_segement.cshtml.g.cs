#pragma checksum "E:\scratch\RoadInv_Overhaul\road-inv2\RoadInv\Views\Shared\new_segement.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "53d780316fc90f5b5a4233b0e0ba837c93e4e75a"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"53d780316fc90f5b5a4233b0e0ba837c93e4e75a", @"/Views/Shared/new_segement.cshtml")]
    public class Views_Shared_new_segement : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "E:\scratch\RoadInv_Overhaul\road-inv2\RoadInv\Views\Shared\new_segement.cshtml"
...
#nullable restore
#line 6 "E:\scratch\RoadInv_Overhaul\road-inv2\RoadInv\Views\Shared\new_segement.cshtml"
...
<div class=""main-content"">
    <div class=""master-grid"">
        <div id=""box-coreChar"" class='property-box'>
            ...
            <div class=grid-container>
                ...
                <div>
                    <label data-toggle=""tooltip"" data-placement=""top"" title=""ArDOT County Number. Not to be confused with FHWA");
            WriteLiteral(@" County Numbers."">County</label>
                ...
                <div>
                    <label data-toggle=""tooltip"" data-placem");
            WriteLiteral(@"ent=""top"" title=""ARNOLD section number. 3 digit sections are typically reserved for Y leg segments"">Section</label>
                ...
                <div>
                    <label data");
            WriteLiteral(@"-toggle=""tooltip"" data-placement=""top"" title=""The Begining Log Mile of the segment"">BLM</label>
    ...
    <div class=""master-grid"">
        <div id=""box-nest"">
           ...
           ");
            WriteLiteral(@"             <div>
                        ...
                        <div>
                            <label data-toggle=""tooltip"" data-placement=""top"" title=""Indicates based on its fu");
            WriteLiteral(@"nction in the vacinity"">Type Road</label>
            ...
            WriteLiteral(@"ption>
                        ...
                        <div>
                            ...
                            <select id=""gather-UrbanCode"">
                                ...
                                <option value=""30925"">30925 - Fort Smith</option>
                                <option value=""43345"">43345 - Jonesboro</option>
                        ");
            WriteLiteral(@"        <option value=""56116"">56116 - West Memphis</option>
                ...
                <div id=""box-shoulder"" class=""property-box"">
                    ...
                    <div class=""grid-container"">
                        <div>
                            ...
                            <input i");
            WriteLiteral(@"d=""gather-LeftShoulderWidth"" type=""text"" />
                        </div>
                        <div>
        ...
        <div id=""box-physical"" class=""property-box"">
            ...
            <div class=""grid-container"">
                <div>
                    ...
                    <select id=""gather-SurfaceType"">
                        ...
                        <option value=""1"">1 - Asphalt</option>
                        <option value=""2"">2 - Concrete - JPCP</option>
                        <option value=""4"">4 - Concrete - CRCP</option>
                        <option value=""5"">5 - Asph");
            WriteLiteral(@"alt Over Concrete</option>
                    </select>
                </div>
                <div>
                ...
                <div>
                  ...
                  ");
            WriteLiteral(@"      <option value=""6"">6 - Left turn only</option>
            ...
            <div class=""grid-container"">
                <div>
                  ...
                  ");
            WriteLiteral(@"      <option value=""4"">4 - Divided multi-lane</option>
                    </select>
                </div>
                <div>
                ...
                <div>
                    <label data-toggle=""tooltip"" data-placement=""top"" title=""Describes materials and barriers in the median that help seperate the two lanes of traffic"">Median <br /> Type</label>
                    <select id=""gather-MedianType"">
                        <option></option>
                        <option va");
            WriteLiteral(@"lue=""0"">0 - No median</option>
        ...
        <div id=""box-lanes"" class=""property-box"">
            ...
            <div class=""grid-container"">
                <div>
                    <label data-toggle=""tooltip"" data-placement=""top"" title=""In a divided highway, the field describes the number of lanes");
            WriteLiteral(@" in a single direction of travel. In non-divided highway segements"">One Direction Number of Lanes</label>
    ...
    <div class=""master-grid"">
        <div id=""box-system"" class='property-box'>
            ...
            <div class=""grid-container"">
                <div>
                    <label data-toggle=""tooltip"" data-placement=""top"" title='Classification on the FHWA Functional Class System. Please refer to ""Highway functional classification concepts, criteria and proedcures guide"".'>F");
            WriteLiteral(@"unctional <br /> Class</label>
                ...
                <div>
                    <label data-toggle=""tooltip"" data-placement=""top"" title=""National Highway System Status including intermodal connectors like major aiports and truck transfer stations"">NHS</label>
                    <select id=""gather-NHS"">
                        <option></option>
                        <option value=""0"">0");
            WriteLiteral(@" - Not on NHS</option>
            ...
            WriteLiteral(@"ion>
                ...
                <div>
                    ...
                    <select id=""gather-GovermentCode"">
                        ...
                        <option val");
            WriteLiteral(@"ue=""63"">63 - Fish & Wildlife</option>
                ...
                <div>
                    <label data-toggle=""tooltip"" data-placement=""top"" title=""Membership in a specialized highway system"">Special <br /> Systems</label>
                    <select id=""gather-SpecialSystems"">
                        <option></option>
                        <option value=""1"">1 - Not a special System</option>
               ");
            WriteLiteral(@"         <option value=""3"">3 - Airport Road</option>
                ...
                <div>
                    <label data-toggle=""tooltip"" data-placement=""top"" title=""Indicates if the road is close or open to traffic. Also indicates if its a segement that is not tracked as part of the roadway inventory"">System <br /> Status</label>
  ...
  ");
    ...
    <div class=""master-grid"">
        ...
        <div id=""box-dynamic"" class='property-box'>
            ...
            <p>These Fields Aut");
            WriteLiteral(@"omatically get added to the interface if new fields are added to the roadway inventory database table</p>
        </div>
    ...
    <div class=""grid-container"">
        ...
        <div>
            <button data-toggle=""tooltip"" data-placement=""top"" title=""Create a 100% duplicate record from the currently selected record"" class=""segment-button"">Duplicate record</button>
        </div>
        <div>
            <button data-toggle=""tooltip"" data-placement=""top"" title=""copy the currently selected record except flip the attributes so its sitting on the opposite side of a divided highway"" class=""segment-b");
            WriteLiteral(@"utton"">Mirror Record</button>
        </div>
        <div>
